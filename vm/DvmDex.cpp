...
int dvmDexFileOpenFromFd(int fd, DvmDex** ppDvmDex)
{
    ...
    coverageData = (u1*) malloc(sizeof(u1) * memMap.length);
    if (coverageData == NULL)
        goto bail;      /* alloc failure */
    memset(coverageData, 0, sizeof(u1) * memMap.length);
    pDvmDex->coverageData = coverageData;
...
int dvmDexFileOpenPartial(const void* addr, int len, DvmDex** ppDvmDex)
{
    ...
    */
    ...
    coverageData = (u1*) malloc(sizeof(u1) * len);
    if (coverageData == NULL)
        goto bail;      /* alloc failure */
    memset(coverageData, 0, sizeof(u1) * len);
    pDvmDex->coverageData = coverageData;
